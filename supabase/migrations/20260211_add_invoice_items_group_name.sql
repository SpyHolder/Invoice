-- Add group_name to invoice_items table and update functions
-- This allows invoice items to retain the group_name from delivery order items
-- for proper display grouping in invoice templates

-- Add group_name column to invoice_items
ALTER TABLE invoice_items
ADD COLUMN IF NOT EXISTS group_name TEXT;

COMMENT ON COLUMN invoice_items.group_name IS 'Group name copied from delivery order items for organizing items in invoice display (e.g., "Equipment", "Materials")';

-- Update populate_invoice_from_dos function to copy group_name
