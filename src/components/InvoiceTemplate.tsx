		...
		return (
			...
			>
				...
				<div className="grid grid-cols-2 gap-8 mb-6">
					{/* Billing Address */}
					<div>
						<div className="bg-cyan-500 text-white font-bold px-2 py-1 mb-2 text-center uppercase">
							Billing Address
						</div>
						<div className="border border-black p-2 h-32">
							<p>
								To: {customer.attn_name || "Finance Department"}
							</p>
					...
					<div>
						...
						<div className="border border-black p-0 min-h-32">
							...
							<table className="w-full text-xs">
								<tbody>
									<tr>
										<td className="font-semibold pl-2 py-0.5 w-1/3">
											Invoice No
										</td>
										<td className="py-0.5">
									...
									<tr>
										<td className="font-semibold pl-2 py-0.5 align-top">
											DO Number
										</td>
										<td className="py-0.5 pr-2 whitespace-pre-line">
											{doNumber ||
												invoice.do_number_ref ||
												"-"}
										</td>
									</tr>
									<tr>
				...
				<table className="w-full border-collapse border border-black mb-4 text-xs">
					<thead>
						<tr className="bg-white border-b border-black">
							<th className="border-r border-black py-0.5 px-1 text-center w-10">
								No
							</th>
							<th className="border-r border-black py-0.5 px-1 text-left w-24">
								Items
							</th>
							<th className="border-r border-black py-0.5 px-1 text-left">
								Description
							</th>
							<th className="border-r border-black py-0.5 px-1 text-center w-12">
								QTY
							</th>
							<th className="border-r border-black py-0.5 px-1 text-center w-12">
								UOM
							</th>
							<th className="border-r border-black py-0.5 px-1 text-center w-24">
								Unit Price (SGD)
							</th>
							<th className="py-0.5 px-1 text-center w-24">
								Total (SGD)
							</th>
						</tr>
					</thead>
						...
						{doSections && doSections.length > 0
							? doSections.map((section) => {
								const sectionItems = items.filter(
									(item) =>
										item.do_section_id === section.id,
								);
								let itemCounter = items.filter(
									(item) =>
										doSections.findIndex(
											(s) =>
												s.id === item.do_section_id,
										) <
										doSections.findIndex(
											(s) => s.id === section.id,
										),
								...
								const grouped = sectionItems.reduce(
									(acc, item) => {
								...
								rows.push(
									<tr
										...
										className="bg-blue-100 border-b border-black"
									>
										<td
											colSpan={7}
										...
										>
											...
											{section.section_label ||
												`Delivery ${section.section_number}`}
										</td>
									</tr>,
								);
										...
										groupItems.forEach((item, idx) => {
											...
											rows.push(
												...
												>
													...
													{idx === 0 && (
														<td
															className="border-r border-black py-0.5 px-1"
															rowSpan={
																groupItems.length
															}
														>
													...
													<td className="border-r border-black py-0.5 px-1 text-right">
				...
				<div className="flex justify-end mb-4 text-xs">
					<div className="w-1/3 border border-black">
						<div className="flex justify-between border-b border-black py-0.5 px-1">
							<span>GST {(invoice as any).tax_rate || 0}%</span>
							<span>
								{((invoice as any).tax_amount || 0).toFixed(2)}
							</span>
						</div>
						<div className="flex justify-between border-b border-black py-0.5 px-1">
							<span>Sub-Total</span>
						...
						<div className="flex justify-between py-0.5 px-1 font-bold">
							<span>Total (SGD)</span>
				...
				<div className="mt-4 text-xs">
					...
					<table className="border-collapse border border-black w-full">
						<tbody>
							<tr>
								<td className="border border-black py-0.5 px-1 w-1/3 font-semibold">
									Bank Name (Final Destination Bank)
								</td>
							...
							<tr>
								<td className="border border-black py-0.5 px-1 font-semibold">
									Bank Address
								</td>
								<td className="border border-black py-0.5 px-1">
									No.23 Serangoon Central, #01-52/53 NEX,
									Singapore 556083
								</td>
							</tr>
							<tr>
